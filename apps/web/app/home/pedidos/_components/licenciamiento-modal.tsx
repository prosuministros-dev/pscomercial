...
export function LicenciamientoModal({
  ...
  const handleGuardarLicencia = () => {
    if (
      !licenciaData.razonSocial ||
      !licenciaData.nit ||
      !licenciaData.contacto
    ) {
      toast.error('Complete los campos obligatorios');
      return;
    }
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <Select
                  value={adpData.marca}
                  onValueChange={(value) =>
                    setAdpData({ ...adpData, marca: value })
                  }
                >
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, serial: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  value={adpData.plan}
                  onChange={(e) =>
                    setAdpData({ ...adpData, plan: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, duracion: e.target.value })
                  }
              ...
              <div className="md:col-span-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, nombreCliente: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, emailCliente: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, telefonoCliente: e.target.value })
                  }
              ...
              <div className="md:col-span-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, direccion: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, fechaInicio: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAdpData({ ...adpData, fechaFin: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({ ...appleData, appleId: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({ ...appleData, serial: e.target.value })
                  }
                  placeholder="C02..."
                  className="mt-1"
                />
              ...
              <div className="md:col-span-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({ ...appleData, depToken: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({ ...appleData, contacto: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({ ...appleData, organizacion: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({ ...appleData, servidorMDM: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({ ...appleData, perfilMDM: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAppleData({
                      ...appleData,
                      fechaEnrolamiento: e.target.value,
                    })
                  }
                  className="mt-1"
                />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setAppleData({ ...appleData, estado: value })
                  }
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setGarantiaData({ ...garantiaData, marca: value })
                  }
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setGarantiaData({ ...garantiaData, serial: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setGarantiaData({
                      ...garantiaData,
                      duracionAnios: parseInt(e.target.value) || 3,
                    })
                  }
                  className="mt-1"
                />
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setLicenciaData({ ...licenciaData, proveedor: value })
                  }
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setLicenciaData({ ...licenciaData, tipo: value })
                  }
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setLicenciaData({ ...licenciaData, nit: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setLicenciaData({ ...licenciaData, cargo: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setLicenciaData({ ...licenciaData, email: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setLicenciaData({ ...licenciaData, pais: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setLicenciaData({ ...licenciaData, departamento: value })
                  }
                >
                  <SelectTrigger className="mt-1">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setLicenciaData({ ...licenciaData, ciudad: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90vh] max-w-4xl flex-col overflow-hidden p-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="sr-only">
                  Formulario para gestionar licencias, garantías y activos del
                  pedido
                </DialogDescription>
        ...
        <ScrollArea className="flex-1 px-6 py-4">
          <Card className="p-4">{renderFormulario()}</Card>
        </ScrollArea>
      </DialogContent>
    </Dialog>
  );
